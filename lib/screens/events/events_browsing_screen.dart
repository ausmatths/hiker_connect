...
import '../../models/events_view_type.dart'; // Import the enum
import '../../providers/events_provider.dart'; // Changed to use EventsProvider instead
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        heroTag: 'createEventFAB_${widget.initialViewType.toString()}',
        onPressed: () {
